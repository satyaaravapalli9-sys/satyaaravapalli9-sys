...
```mermaid
graph TB
    A[Strategic Vision] --> B[Technical Leadership]
    A --> C[Cloud Architecture]
    B --> D[Microservices Design]
    B --> E[SRE Practices]
    C --> F[AWS Infrastructure]
    C --> G[Event-Driven Systems]
    D --> H[Production Delivery]
    E --> H
    F --> H
    G --> H
    H --> I[Business Impact]
    I --> J[99.9% Uptime]
    I --> K[40% Performance Gain]
    I --> L[60% MTTR Reduction]
    
    style A fill:#1e3a8a,stroke:#3b82f6,color:#fff
    style I fill:#059669,stroke:#10b981,color:#fff
    style J fill:#0891b2,stroke:#06b6d4,color:#fff
    style K fill:#0891b2,stroke:#06b6d4,color:#fff
    style L fill:#0891b2,stroke:#06b6d4,color:#fff
```
...
```mermaid
timeline
    title Professional Journey - From Developer to Engineering Leader
    section Foundation
    ...
    2020-2022 : MS Computer Science
              : Missouri State University
              : Advanced Algorithms
              : Distributed Systems
    section Leadership Era
    2022-Present : Full Stack Engineer & SRE
                 : United Airlines
                 : Led 15+ Microservices
